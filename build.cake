...
var solutionPath = "./src/Serilog.Sinks.Burst.sln";
...
Task("Publish")
    ...
    .Does(() =>
    {
		 var projects = GetFiles("./src/Serilog.Sinks.Burst/*.csproj");
		 foreach(var project in projects)
		 {
...
Task("Package-NuGet")
    ...
    .Does(() =>
    {
	     ...
	     var nuGetPackSettings   = new NuGetPackSettings {
			...
			NuGetPack("Serilog.Sinks.Burst.nuspec", nuGetPackSettings);
...
Task("Update-Version")
    .Does(() =>
    {
        ...
        var file =
            MakeAbsolute(File("./src/Serilog.Sinks.Burst/Serilog.Sinks.Burst.csproj"));
